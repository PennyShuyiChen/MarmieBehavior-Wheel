...
% Reward setting
P.rewardNumber = [1, 2];   % Max juice drop [checkpoint, success]
S.rewardNumber = 'Number of juice pulses to deliver:';

%********PENNY CODDING***********%
% Stimulus settings
P.ecc = 10;%5;  % eccentricity of the grating at the trial start 
...
P.contrast = 0.8, 0.9, 1; %0.10 .015, .03, .06, .125, .25, .5;
P.minContrast = 0.8; %0
S.minContrast = 'Min contrast to test';
P.maxContrast = 1;
S.maxcontrast = 'Max contrast to test';
P.ContrastNum = 10;
S.ContrastNum = 'Number of contrast levenonels';
...
P.initWinRadius = 1000;%1 %(skip)
S.initWinRadius = 'Enter to initiate fixation (deg):';
P.fixWinRadius = 1000;%2.0; %1.5;
